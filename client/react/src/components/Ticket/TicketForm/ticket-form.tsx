...
const STATE_OPTIONS = [
	...
	{ value: "pendingTechnical", label: "Pending (Technical)" },
		...
		<div className="content page-ticket">
			<header className="form-header">
				<div className="form-heading">
					<span className="form-eyebrow"><Sparkles size={13} /> Incident</span>
					<h1 className="form-title">New incident</h1>
					<p className="form-subtitle">Capture the details and route it to the right team.</p>
				</div>
					...
					<section className="form-card card-summary">
						<div className="card-head">
							<div className="card-head-text">
								...
								<p className="section-hint">What's going on and what's been tried.</p>
							</div>
						</div>
					...
					<section className="form-card">
						<div className="card-head">
							<div className="card-head-text">
								...
								<p className="section-hint">Helps categorize and find similar incidents.</p>
							</div>
						</div>
					...
					<section className="form-card">
						<div className="card-head">
							<div className="card-head-text">
								...
								<p className="section-hint">Who reported it and who it's for.</p>
							</div>
						</div>
							...
							<div className="segmented" role="group" aria-label="Contact type">
								{CONTACT_OPTIONS.map((opt) => (
									<button
										type="button"
										key={opt.value}
										className={ticket.contact_type === opt.value ? "active" : ""}
